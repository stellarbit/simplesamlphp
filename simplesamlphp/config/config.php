...
$config = array(
    ...
    */
     ...
     */
    'auth.adminpassword' => '123alksdjflkajsdlfkjasreljsdkfjsdkfjalsdjflaksdfjlkasjdf',
     ...
     */
    'secretsalt' => 'defaultsecretskasjdflkjasdlfjasldfjkalt',
 ...
 /*
     ...
     */
    'database.dsn' => 'pgsql:host=localhost;dbname=saml',
   ...
   /*
     ...
     *
     * Example:
 "session.cookie.domain" => ".lucysecurity.com",
     */
 "session.cookie.domain" => ".lucysecurity.com",
  ...
  /*
     ...
     * syntaxes.
     */
    'store.sql.dsn'                 => 'pgsql:host=localhost;port=5432;dbname=simplesaml',

    /*
     * The username and password to use when connecting to the database.
     */
    'store.sql.username' => "simplesaml",
  "store.sql.password" => "lFildxbezhKroA==",
